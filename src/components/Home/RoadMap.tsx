...
function RoadMap() {
  return (
    <div className="my-20 bg-[#050E17] pt-32 container relative">
      ...
      <div className="px-56 pb-32 pt-20">
        <div className="text-[#B2FFAC] font-fira text-3xl font-extrabold text-right py-10">
          Phase One
        </div>
        <div className="flex items-center relative h-56">
                ...
                >
                  ...
                  <span
                    className={classNames(
                      "text-white/50 my-2 w-40 absolute -translate-x-1/2",
          ...
          <div className="text-[#EDD955] font-fira text-3xl font-extrabold absolute -bottom-1/2 -translate-y-1/2">
            Phase Two
          </div>
          <div className="absolute right-0 translate-y-1/2 border-r-2 border-white/20 h-96 grid place-items-center">
        ...
        <div className="flex items-center relative h-56 mt-40">
          <div className="border-t-2 border-white/20 w-1/12"></div>{" "}
          <div className="text-[#ED5555] font-fira text-3xl font-extrabold absolute -bottom-1/2 -translate-y-1/2 right-0">
            Phase Three
          </div>
          <div className="border-t-2 border-dashed border-white/20 w-10/12 relative">
            <div className="absolute flex justify-between w-full -translate-y-1/2 h-56 items-center">
          ...
          <div className="border-t-2 border-white/20 w-2/12"></div>
          <div className="absolute left-0 translate-y-1/2 border-l-2 border-white/20 h-96 grid place-items-center">
            <div className="-translate-x-1/2 bg-[#050E17] py-10">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
